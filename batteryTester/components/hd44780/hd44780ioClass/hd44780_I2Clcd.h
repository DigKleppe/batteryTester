...
// It will lock up module and/or the AVR i2c h/w and require a power cycle to
// reset. NOTE:
//		This device needs pullups on the bus signals.
//		While it will usually work on an AVR platform without external
// pullups, 		it doesn't always work.
//
...
public:
  ...
  hd44780_I2Clcd(uint8_t i2c_addr = 0)
      : _Addr(i2c_addr) {} // zero addres means auto locate
