...
// assertComparativeEquivalent(expected, actual);    // abs(a - b) == 0 or (!(a
// > b) && !(a < b)) assertComparativeNotEquivalent(unwanted, actual); // abs(a
// - b) > 0  or ((a > b) || (a < b)) assertLess(upperBound, actual); // a < b
